...
const StatsPage = () => {
  ...
  // already-parsed list instead of re-querying + re-parsing. Suspends to the
  // route-level Spinner (AppLayout) until resolved and throws a load failure to the
  // route error boundary there, so this page has no loading/error branch.
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-baseline justify-between gap-3">
                        <span className="text-sm text-text">{t('money.withDelivery')}</span>
