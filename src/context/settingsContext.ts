...
// The settings persisted by the dialog's Save. Theme/font preview live before
// they are saved; the order defaults don't change the live app (they only seed
// the next new order), so they have no preview — they apply on Save.
